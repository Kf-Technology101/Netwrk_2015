...
<div id="create_topic" data-topic_id="<?php echo $topic->topic->id; ?>" data-city="<?php echo $city_id ?>" data-group="<?php echo $group_id;?>" data-by-group="<?php echo $by_group; ?>" data-isCreateFromBlueDot="<?php echo $isCreateFromBlueDot; ?>"
    ...
    <div class="container">
        <div class="topic">
            ...
            <input type="text" class="name_topic" maxlength="128" placeholder="Channel Title" value="<?php echo isset($topic->topic->title) ? $topic->topic->title: '' ?>">
        </div>
        ...
        <div class="post">
            <div class="post-title">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="name_post" data-post_id="<?php echo isset($topic->post->post_id) ? $topic->post->post_id : '' ?>" maxlength="128" placeholder="Head-line" value="<?php echo isset($topic->post->post_title) ? $topic->post->post_title : '' ?>">
                </div>
            </div>
            <div class="post-message">
                <p class="title"> Message </p>
                <textarea class="message" placeholder="Don't be shy! Say something!" maxlength="1024"><?php echo isset($topic->post->content) ? $topic->post->content : '' ?></textarea>
            </div>
        </div>
