			...
			<div class="iw-content">
				...
				<div id="communityInfo" class="clearfix">
					...
					<div class="create-section-wrapper">
						<div class="iw-subTitle col-xs-12 create-section" id="actionBuildCommunity"><a href="javascript:" class="create-button line-button" onclick="Map.CreateLocationPost(Map.blueDotLocation.zipcode);"><span>Create a Line</span></a></div>
