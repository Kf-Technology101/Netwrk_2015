...
<script id="account_nav_dropdown" type="text/x-underscore-template" >
    <div id='account_nav_wrapper' class="btn-group profile-dropdown dropup" role="group">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
            ...
            <li class='avatar-dropdown-menu'><a class="profile-trigger"><i class="fa fa-user"></i> Profile</a></li>
